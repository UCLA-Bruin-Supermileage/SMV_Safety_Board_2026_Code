...
#define Hydrogen_Output_Pin GPIO_PIN_14
#define Hydrogen_Output_GPIO_Port GPIOC
#define Hydrogen_Output_EXTI_IRQn EXTI15_10_IRQn
...
#define relay_output_Pin GPIO_PIN_0
